...
**Live on [Streamlit](https://emirhanserveren-nft-collabot-deploy-mml6j8.streamlit.app/) as a web page!**
...
### MONITORIZE FEATURES AND THEIR TASKS

It is indispensable to keeping track of the project to manage scope and time. The issues are opened under the relevant features on [the project page](https://github.com/users/EmirhanServeren/projects/1)
